require "rspec"
require "solutions/year2023/day07"

RSpec.describe Solutions::Year2023::Day07 do
	...
	describe "#part1" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part1(example_input_part_one)).to eq(6440)
			end
		end
	...
	describe "#part2" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part2(example_input_part_two)).to eq(5905)
			end
		end
