require "rspec"
require "solutions/year2025/day03"

RSpec.describe Solutions::Year2025::Day03 do
	...
	describe "#part1" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part1(example_input_part_one)).to eq(357)
			end
		end
	...
	describe "#part2" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part2(example_input_part_two)).to eq(3121910778619)
			end
		end
