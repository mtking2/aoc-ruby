require "rspec"
require "solutions/year2025/day02"

RSpec.describe Solutions::Year2025::Day02 do
	...
	describe "constants" do
		it "has the correct year" do
			expect(described_class::YEAR).to eq(2025)
		end

		it "has the correct day" do
			expect(described_class::DAY).to eq(2)
		end
	end
	...
	describe "#part1" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part1(example_input_part_one)).to eq(1227775554)
			end
		end
	...
	describe "#part2" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part2(example_input_part_two)).to eq(4174379265)
			end
		end
		...
		context "with actual input" do
			it "returns the correct answer" do
				...
				expect(part2_answer).to eq(65794984339)
			end
		end
	end
end
