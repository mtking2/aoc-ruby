require "rspec"
require "solutions/year2025/day04"

RSpec.describe Solutions::Year2025::Day04 do
	...
	describe "constants" do
		...
		it "has the correct day" do
			expect(described_class::DAY).to eq(4)
		end
	end
	...
	describe "#part1" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part1(example_input_part_one)).to eq(13)
			end
		end
	...
	describe "#part2" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part2(example_input_part_two)).to eq(43)
			end
		end
