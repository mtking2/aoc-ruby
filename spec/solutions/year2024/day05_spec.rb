require "rspec"
require "solutions/year2024/day05"

RSpec.describe Solutions::Year2024::Day05 do
	...
	describe "constants" do
		...
		it "has the correct day" do
			expect(described_class::DAY).to eq(5)
		end
	end
	...
	describe "#part1" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part1(example_input_part_one)).to eq(143)
			end
		end
	...
	describe "#part2" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part2(example_input_part_two)).to eq(123)
			end
		end
