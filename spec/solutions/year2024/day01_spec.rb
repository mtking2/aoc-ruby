require "rspec"
require "solutions/year2024/day01"

RSpec.describe Solutions::Year2024::Day01 do
	...
	describe "#part1" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part1(example_input_part_one)).to eq(11)
			end
		end
	...
	describe "#part2" do
		context "with example input" do
			it "returns the expected result" do
				...
				expect(solution.part2(example_input_part_two)).to eq(31)
			end
		end
